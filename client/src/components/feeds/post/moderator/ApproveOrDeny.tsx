  ...
  return (
    <div className="ApproveOrDeny">
      ...
      <button
        ...
        onClick={() => props.approve(contentWarningInputRef.current?.value ?? "")}
      >
        <FaCheck />
      </button>
      <button className="ApproveOrDenyButton DenyButton" onClick={() => props.deny(contentWarningInputRef.current?.value ?? "")}>
        <FaTimes />
      </button>
    </div>
  );
